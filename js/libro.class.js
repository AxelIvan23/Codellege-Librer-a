class Libro{
        ...
        tr.innerHTML = `<th scope="row">${this.id}</th>
                        ...
                        <td>
                            <div class="btn-group" role="" aria-label="Basic example">
                                <button id="editar${this.id}" type="button" class="btn btn-success" data-toggle="modal" data-target="#modalAdd">
    ...
    eliminar(element){
        ...
        if(element.tagName === 'I'){
            ...
            LocalStorageOperation.EliminarLS(element.parentElement.parentElement.parentElement.parentElement.id);
        }else{
